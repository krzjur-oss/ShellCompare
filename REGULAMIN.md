# Regulamin i Polityka Prywatności aplikacji „ShellCompare”

**Wersja v1.3.0 · obowiązuje od 17 lipca 2026 r.**

---

## § 1. Postanowienia ogólne

1. Niniejszy Regulamin określa zasady korzystania z aplikacji **„ShellCompare”** (dalej: „Aplikacja”), dostępnej pod adresem strony internetowej programu.
...
2. Dane wprowadzane do Aplikacji (np. wpisywane polecenia, postępy wyzwań i streak, preferowany motyw terminala) przechowywane są **wyłącznie lokalnie w pamięci przeglądarki użytkownika** (`localStorage`) i nigdy nie opuszczają jego urządzenia.
...
5. Użytkownik może w każdej chwili usunąć swoje dane, czyszcząc dane przeglądarki lub korzystając z funkcji resetowania postępów.
